...
if ( $posttags ) {
	...
	while( have_posts() ) { the_post(); ?>
		<li>
			<a href="<?php the_permalink(); ?> " title="<?php the_title(); ?>" rel="nofollow"><?php freshsky_get_thumb_image() ?></a>
			<span class="related-posts-title"><a href="<?php the_permalink(); ?>" ><?php echo cut_str($post->post_title,24); ?></a></span>
		</li>
	<?php
