...
$options[] = array( "name" => "显示小logo",
					"desc" => "Yes代表使用小logo(70*70),No代表使用大logo(180*90)",
					"id" => "LogoSmall",
					"type" => "radio",
					"buttons" => array('yes','no'),
					"std" => 1);
...
$options[]=	array(	"name" => "CMS版",
					"desc" =>"为空时是首页",
					"id" => "HomeStyleUrl",
					"type" => "dropdown",
					"subtype" => "page");
			
$options[]=	array(	"name" => "博客版",
					"desc" => "为空时是首页",
					"id" => "BlogStyleUrl",
					"type" => "dropdown",
					"subtype" => "page");

$options[]=	array(	"name" => "移动版",
					"desc" => "为空时是首页",
					"id" => "MoblieStyleUrl",
					"type" => "dropdown",
					"subtype" => "page");
...
$options[] = array(
					"name" => "关注我们",
					"desc" => "为博客填写博客微博、RSS等信息",
					"type" => "title_inside",
					);
$options[] = array(	"name" => "站长QQ",
					"desc" => "留空时不显示",
					"id" => "WebmasterQQ",
					"size" => "12",
					"std"=>"799761557",
...
$options[] = array(	"name" => "腾讯微博",
					...
					"id" => "WebmasterQQt",
					"size" => "30",
					"std"=>"http://1.t.qq.com/jiuheqing",
					"type" => "text");
$options[] = array(	"name" => "新浪微博",
					"desc" => "留空时不显示",
					"id" => "WebmasterSina",
					"size" => "30",
					"std"=>"http://weibo.com/519918012",
					"type" => "text");

$options[] = array(	"name" => "RSS订阅",
					"desc" => "留空时不显示",
					"id" => "WebsiteRSS",
					"size" => "30",
...
$options[] = array(	"name" => "统计分析代码<br />Analytics Code",
