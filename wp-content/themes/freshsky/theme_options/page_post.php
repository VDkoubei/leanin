...
----------------------------------------------------------------------------*/
	array(	
					"name" => "文章页选项",
					"desc" => "在文章页single.php中设置的选项",
					"type" => "title_inside",
					),

	array(	"name" => "分享代码<br />Share Code",
					"desc" => "请自行设置分享代码，注意不要超过宽度",
					"id" => "ShareCode",
					"size" => "5",
					"std" => "请自行后台设置分享代码", 
					"type" => "textarea"),
	array(	"name" => "相关文章个数<br />Related Posts",
					"desc" => "请自行设置分享代码，注意不要超过宽度",
					...
					"type" => "text"),
	//广告
	array(	"name" => "顶部广告<br />Related Posts",
					"desc" => "位置在文章页标题的下部",
					"id" => "SingleAdsTop",
					"size" => "3",
					"std"=>"",
					"type" => "textarea"),
	array(	"name" => "底部广告<br />Related Posts",
					"desc" => "位置在文章页评论的下部",
					"id" => "SingleAdsBottom",
					"size" => "3",
					"std"=>"",
