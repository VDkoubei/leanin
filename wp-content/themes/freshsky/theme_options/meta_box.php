 ...
 * @var array
 */
//$index = get_option("kriesi_Fresh Sky_index");
//print_r($index);
...
$boxinfo = array('title' => '视频选项', 'id'=>'video', 'page'=>array('post'), 'context'=>'normal', 'priority'=>'high', 'callback'=>'');


$options[] = array(	"name" => "视频Url",
			"desc" => "请输入视频的html地址",
			"id" => "_post_video",
			"std" => "",
			"button_label" => "插入视频url",
			"size" => 60,
			"type" => "text");
