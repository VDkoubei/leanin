	...
	{	
		...
		if ($category_or_multi == 0) { //单列
			...
			while( have_posts() ) { the_post();$i++;
				...
				<?php }else{?>
					<li><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'freshsky' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php echo cut_str(get_the_title(),36); ?></a></li>
				<?php } ?>
