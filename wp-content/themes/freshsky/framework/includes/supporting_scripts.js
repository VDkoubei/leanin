...
function table_show_hide () {
	var $table = jQuery('.kriesi_options') ;
	$table.eq(0).children("tbody").show();
	
	$table.click(function(event) {
		jQuery(this).children("tbody").slideDown(400).end().siblings(".kriesi_options").find("tbody").slideUp();
	});
