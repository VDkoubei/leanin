...
<?php if ($comments) : ?>
		...
		<h2 class="comments-title">
			<?php
				//_(从这里依据情况显示一个)
				printf( _n( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'freshsky' ),
 ...
 <?php else : // this is displayed if there are no comments so far ?>
		<?php if ('open' == $post->comment_status) : ?>
		 ...
		 <?php else : // comments are closed ?>
			...
			<p class="nocomments"><?php _e( 'Comments are closed.' , 'freshsky' ); ?></p>
		<?php endif; ?>
<?php endif; ?>


<?php if ('open' == $post->comment_status) ://评论表单开始 ?>
	<div id="respond_box">
		<div id="respond">
			...
			<div class="cancel-comment-reply">
				<div id="real-avatar">
					...
					if(isset($_COOKIE['comment_author_email_'.COOKIEHASH])) : ?>
						...
						<img src="<?php  echo my_avatar($comment_author_email, 32);?>" alt="评论者" class="avatar">
					<?php else :?>
    ...
    <?php else : ?>
		...
		<div class="author"><?php printf(__('Welcome <strong>%s</strong>'), $comment_author); ?>
      ...
      <p><?php include(TEMPLATEPATH . '/inc/smiley.php'); ?></p>
