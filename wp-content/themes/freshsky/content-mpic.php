...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<header class="entry-header">
			...
			if ($h_option["general"]["ColorBox"] !="0" && $img_src[0] != '') { ?>
				<a href="<?php echo $img_src[0] ?>" title="<?php the_title(); ?>" class="waterwall-box" ><?php freshsky_get_thumb_image("show", 320); ?></a>
			<?php }else{ ?>
				<a href="<?php echo get_permalink() ?>" title="<?php the_title(); ?>"><?php freshsky_get_thumb_image("show", 320); ?></a>
			<?php } ?>
		...
		<?php 
		if ($h_option['page_post']['PicMeta_can'] == 1) {?>
